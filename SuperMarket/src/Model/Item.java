...
public class Item {
	...
	public Item(String i_Name,String i_Barcode,float i_Price,int i_MaxStockStore,int i_MaxStockWarehouse, int i_AvailableInStore,int i_AvailableInWarehouse) {
		this.Name=i_Name;
